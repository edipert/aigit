...
async function bench() {
    ...
    console.log('Starting benchmark: N+1 insertions...');
    ...
    // Simulate original N+1 code block
    ...
    console.log(`Baseline Execution Time: ${(end - start).toFixed(2)} ms for ${ported} decisions`);
